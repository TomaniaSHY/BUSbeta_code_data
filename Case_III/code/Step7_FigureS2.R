...
### Y by batch
png(filename="../figures/FigureS2(c).png", width = 500, height = 300)
visualize_by_batch(Data = Y, feature_ind = 1:J, title_name = "Raw simulated data", is.Y = TRUE, subgroup_list = Z_real)
dev.off()


### Y_BUSbeta
png(filename="../figures/FigureS2(e).png", width = 500, height = 300)
...
### Y_BUS
png(filename="../figures/FigureS2(f).png", width = 500, height = 300)
...
### Y_ComBat
png(filename="../figures/FigureS2(g).png", width = 500, height = 300)
...
### Y_BEclear
png(filename="../figures/FigureS2(h).png", width = 500, height = 300)
