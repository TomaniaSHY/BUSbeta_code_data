...
## BIC_rec = c(-46832.34, -229205.98, -383862.52, -370445.08, -413386.48, -344029.92, -380964.19, -342291.26, -357869.74, -290600.13)


## Save BIC plot
png(file="../figures/FigureS2(d).png", width = 460, height = 400)
options(scipen = 999)
