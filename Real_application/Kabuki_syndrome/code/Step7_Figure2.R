...
ggsave("../figures/Figure2(a).png", umap_plot_Y, width=9, height=6)
...
ggsave("../figures/Figure2(c).png", umap_plot_YBUSbeta, width=9, height=6)
...
ggsave("../figures/Figure2(d).png", umap_plot_YBUS, width=9, height=6)
...
ggsave("../figures/Figure2(e).png", umap_plot_YCombat, width=9, height=6)
...
ggsave("../figures/Figure2(f).png", umap_plot_YBEclear, width=9, height=6)
